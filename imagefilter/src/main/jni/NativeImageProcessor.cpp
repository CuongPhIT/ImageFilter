...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_applyRGBCurve(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_applyChannelCurves(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_doBrightness(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_doContrast(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_doColorOverlay(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_cuongph_photofilter_imagefilter_imageprocessors_NativeImageProcessor_doSaturation(JNIEnv *env, jobject thiz,
